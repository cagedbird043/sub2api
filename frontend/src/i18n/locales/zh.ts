export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      reAuthorize: '重新授权',
      refreshToken: '刷新令牌',
      viewModelMapping: '查看映射',
      modelMappingDetailsTitle: '模型映射详情',
      mappingRuleCount: '{count} 条规则',
      targetModel: '目标模型',
      mappingSource: '来源',
      mappingSourceCustom: '账号自定义',
      mappingSourceDefault: '平台默认',
      mappingSourceNone: '无',
      noModelMappingConfigured: '当前账号未配置 model_mapping，将按平台默认/透传逻辑处理。',
      antigravityDefaultMappingHint: '当前账号未配置自定义映射，以下展示 Antigravity 平台默认映射。',
      deprecatedMappingTitle: '检测到弃用模型映射',
      deprecatedSuggestedModel: '建议替换为：{model}',
