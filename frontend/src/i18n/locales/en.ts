export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      viewModelMapping: 'View Mapping',
      modelMappingDetailsTitle: 'Model Mapping Details',
      mappingRuleCount: '{count} rules',
      targetModel: 'Target Model',
      mappingSource: 'Source',
      mappingSourceCustom: 'Account Custom',
      mappingSourceDefault: 'Platform Default',
      mappingSourceNone: 'None',
      noModelMappingConfigured: 'No explicit model_mapping is configured for this account. Platform default or passthrough logic will be used.',
      antigravityDefaultMappingHint: 'No custom mapping is configured for this account. Showing Antigravity platform default mapping.',
      deprecatedMappingTitle: 'Deprecated model mappings detected',
      deprecatedSuggestedModel: 'suggested: {model}',
